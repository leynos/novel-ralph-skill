...
# novel done, novel wordcount, novel desloppify, and novel compile --check — over real
...
Feature: the per-chapter deterministic loop composes the spine
  ...
  order — recount, novel done, novel wordcount, novel desloppify, novel compile
  --check — and branches on each command's exit code. These scenarios prove that ordered
