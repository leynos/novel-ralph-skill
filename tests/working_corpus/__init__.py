...
from ._done_predicate_specs import (
    ...
    CONVERGENCE_SENTINEL_NOTE,
    DONE_PREDICATE_ALL_HOLD,
    DONE_PREDICATE_CONVERGENCE_SENTINEL,
    DONE_PREDICATE_FAILERS,
    DONE_PREDICATE_INCIDENTAL_RESOLVED_BLOCKER,
    DONE_PREDICATE_MID_DRAFT_STALE,
    DONE_PREDICATE_NEAR_MISS_BLOCKER,
    DONE_PREDICATE_OBVIOUS_STALE_COMPILE,
    DONE_PREDICATE_RESOLVED_BLOCKER,
    DONE_PREDICATE_SOLE_STALE_COMPILE,
    INCIDENTAL_RESOLVED_BLOCKER_NOTE,
